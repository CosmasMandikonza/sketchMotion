...
export function AIPanel({
  ...
  // Kestra AI Director handlers - DEMO MODE for hackathon
  // TODO: Swap back to real Kestra webhook implementation after demo
  const handleRunKestraDirector = async () => {
    ...
    try {
      ...
      if (error || !data) {
        ...
        throw new Error('No AI Director results found for this board. Run the Kestra workflow first.');
      }
                      ...
                      >
                        {isRunningKestra ? (
                          <>
                            ...
                            {kestraPolling ? "Analyzing with 4 AI Agents..." : "Starting..."}
                          </>
                        ) : (
                          <>
                            <Sparkles className="w-3.5 h-3.5" />
                            Run AI Director Orchestra
                          </>
                        )}
                      </button>
